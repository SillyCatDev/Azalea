package net.thatnoob.azaleawood;
...
import net.thatnoob.azaleawood.util.ModBoatTypes;
import net.thatnoob.azaleawood.util.ModFlammableBlocks;
import net.thatnoob.azaleawood.util.ModStrippableBlocks;
